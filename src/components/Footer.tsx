      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 lg:gap-14">
          ...
          <div>
            ...
            <div className="text-white/40 leading-relaxed space-y-0.5" style={{ fontSize: "13px" }}>
          ...
          <div>
            ...
            <div className="text-white/40 leading-relaxed" style={{ fontSize: "13px" }}>
              <p className="mb-4">TEL : {CLINIC_INFO.phone}</p>
            </div>
        ...
        <div className="border-t border-white/10 mt-10 pt-6">
          ...
          <p className="text-white/[0.12] mt-2 leading-relaxed" style={{ fontSize: "11px" }}>
